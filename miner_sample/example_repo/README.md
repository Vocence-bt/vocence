...
2. Render the chute template (see miner_sample/chute_template) with your `VOCENCE_REPO`, `VOCENCE_REVISION`, `VOCENCE_CHUTES_USER`, `VOCENCE_CHUTE_ID`.
3. Build: `chutes build <module>:chute --local` or `--wait`.
4. Deploy: `chutes deploy <module>:chute --accept-fee`.
5. Commit on chain: model_name, model_revision, chute_id.
